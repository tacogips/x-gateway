...
Example:
  ...
  scripts/render-homebrew-formula.sh 0.1.5 reader Formula/x-gateway-reader.rb
  scripts/render-homebrew-formula.sh 0.1.5 writer Formula/x-gateway-writer.rb
