...
| `completed/x-gateway-mixed-auth-capability-selection.md` | 2026-03-08 | `design-docs/specs/architecture.md#stable-contract-with-internal-adapters` |
| `completed/x-gateway-adapter-contract-hardening.md` | 2026-03-08 | `design-docs/specs/architecture.md#stable-contract-with-internal-adapters` |
...
| `completed/x-gateway-canonical-public-graphql-interface.md` | 2026-04-05 | `design-docs/specs/architecture.md#stable-contract-with-internal-adapters`, `design-docs/specs/command.md#project-owned-graphql-contract`, `design-docs/specs/design-public-graphql-contract.md` |
...
PHASE_TO_PLANS = {
  1: [
    "active/x-gateway-capability-execution-registry.md",
    "active/x-gateway-capability-runtime-extraction.md",
    "active/x-gateway-layered-module-extraction.md",
    "active/x-gateway-registry-driven-routing.md",
